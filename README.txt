...
a persistence unit "EvaluacionWSAtancuriPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "EvaluacionWSAtancuri\pom.xml":
...
artifact ("EvaluacionWSAtancuri.war") is already built. You can build
